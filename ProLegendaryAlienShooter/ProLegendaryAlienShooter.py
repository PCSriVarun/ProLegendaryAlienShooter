...
pygame.display.set_caption("ProLegendaryAlienShooter")
...
RED_LASER = pygame.image.load(os.path.join("assets", "red laser.png"))
...
def main_menu():
    ...
    while run:
        ...
        title_label = title_font.render("! Game By P.C.Sri Varun !", 1, (250,250,250))
        ...
        title_label = title_font.render("! Press Left Mouse To Begin !", 1, (250,250,250))
